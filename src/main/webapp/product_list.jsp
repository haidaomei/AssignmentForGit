			...
			<section class="content">
				<div class="container-fluid"><jsp:include page="flash.jsp" /><div class="card">
						<div class="card-header">
							<form class="form-inline" action="${pageContext.request.contextPath}/product/list" method="get">
								<input name="keyword" value="${keyword}" class="form-control mr-2" placeholder="产品名称">
								<button class="btn btn-primary mr-2">
									<i class="fas fa-search"></i>
									搜索
								</button>
								<a class="btn btn-light" href="${pageContext.request.contextPath}/product/list">重置</a>
							</form>
						</div>
