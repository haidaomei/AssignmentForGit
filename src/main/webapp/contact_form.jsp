...
<body class="hold-transition sidebar-mini">
	<div class="wrapper"><jsp:include page="navbar.jsp" /><jsp:include page="sidebar.jsp" /><div class="content-wrapper">
			...
			<section class="content">
				<div class="container-fluid">
					<form method="post" action="${pageContext.request.contextPath}/contact/save">
							...
							<div class="card-body">
								<div class="row">
									<div class="form-group col-md-6">
										...
										<select name="customerId" class="form-control" required>
											...
											<c:forEach items="${customerList}" var="c">
												<option value="${c.id}" ${contact.customerId==c.id||(empty contact&&selectedCustomerId==c.id)?'selected':''}>${c.customerName}</option>
											</c:forEach>
										</select>
									</div>
									...
									<div class="form-group col-md-4">
										<label>职务</label>
										<input name="position" value="${contact.position}" class="form-control">
									</div>
									<div class="form-group col-md-4">
										<label>手机</label>
									...
									<div class="form-group col-md-4">
										<label>微信</label>
										<input name="wechat" value="${contact.wechat}" class="form-control">
									</div>
									<div class="form-group col-md-4 pt-md-4">
										<label class="mr-3">
											<input type="checkbox" name="isPrimary" value="1" ${contact.isPrimary==1?'checked':''}>
											主联系人
										</label>
										<label>
											<input type="checkbox" name="isDecisionMaker" value="1" ${contact.isDecisionMaker==1?'checked':''}>
											决策人
										</label>
									</div>
									<div class="form-group col-md-4">
										<label>兴趣爱好</label>
										<input name="hobby" value="${contact.hobby}" class="form-control">
									</div>
									<div class="form-group col-12">
										<label>备注</label>
										<textarea name="remarks" class="form-control" rows="4"><c:out value="${contact.remarks}" /></textarea>
									</div>
								</div>
							</div>
							<div class="card-footer text-right">
								<a href="${pageContext.request.contextPath}/contact/list" class="btn btn-light">取消</a>
