			...
			<section class="content">
				<div class="container-fluid"><jsp:include page="flash.jsp" /><div class="card">
						<div class="card-header">
							<form class="form-inline" action="${pageContext.request.contextPath}/opportunity/list" method="get">
								<input name="keyword" value="${keyword}" class="form-control mr-2" placeholder="商机编号、标题或客户">
								<button class="btn btn-primary mr-2">
									<i class="fas fa-search"></i>
									搜索
								</button>
								<a class="btn btn-light" href="${pageContext.request.contextPath}/opportunity/list">重置</a>
							</form>
						</div>
