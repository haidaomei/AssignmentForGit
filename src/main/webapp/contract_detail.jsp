                    ...
                    <div class="content-wrapper">
                        <div class="content-header">
                            <div class="container-fluid d-flex justify-content-between">
                                ...
                                </div><a href="${pageContext.request.contextPath}/contract/edit?id=${contract.id}"
                                    class="btn btn-primary"><i class="fas fa-edit"></i> 编辑合同</a>
                            </div>
                        </div>
                                ...
                                <div class="row">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        ...
                                                        <div class="detail-value"><a
                                                                href="${pageContext.request.contextPath}/customer/detail?id=${contract.customerId}">${contract.customerName}</a>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <div class="detail-label">合同金额</div>
                                                        <div class="detail-value money text-primary">¥
                                                            <fmt:formatNumber value="${contract.contractAmount}"
                                                                pattern="#,#00.00" />
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4">
                                                        ...
                                                        <div class="detail-value"><span
                                                                class="badge badge-success">${contract.businessStatus}</span>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4">
                                                    ...
                                                    <div class="col-md-4">
                                                        ...
                                                        <div class="detail-value">${contract.startDate} 至
                                    ...
                                    <div class="col-lg-4">
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                <c:choose>
                                                    <c:when test="${not empty contract.opportunityId}"><a
                                                            href="${pageContext.request.contextPath}/opportunity/detail?id=${contract.opportunityId}"><i
                                                                class="fas fa-chart-line mr-2"></i>
                                                            <c:out value="${contract.opportunityTitle}" />
                                                        </a></c:when>
                                                    <c:otherwise><span class="text-muted">未关联商机</span></c:otherwise>
                                                </c:choose>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <tbody>
                                                <c:forEach items="${contract.items}" var="x">
                                                    <tr>
                                                        ...
                                                        <td>${x.quantity}</td>
                                                        <td>¥
                                                            <fmt:formatNumber value="${x.unitPrice}"
                                                                pattern="#,#00.00" />
                                                        </td>
                                                        <td class="money">¥
                                                            <fmt:formatNumber value="${x.subtotal}"
                                                                pattern="#,#00.00" />
                                                        </td>
                                                    </tr>
                                                </c:forEach>
