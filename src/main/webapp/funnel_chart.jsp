				...
				<div class="container-fluid">
					<div class="card">
						<div class="card-header">
							...
							<div class="btn-group btn-group-sm float-right metric-switch">
								<button class="btn btn-outline-primary active" data-metric="value">按商机数量</button>
								<button class="btn btn-outline-primary" data-metric="amount">按预计金额</button>
							</div>
						</div>
						<div class="card-body">
